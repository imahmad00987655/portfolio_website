...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/in/muhammadahmadkhan1029',
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid md:grid-cols-4 gap-12">
          ...
          >
            ...
            <p className="text-gray-200 text-lg leading-relaxed max-w-md">
              Technical Project Manager with a strong Full Stack Development background. Passionate about delivering innovative web solutions, leading cross-functional teams, and bridging the gap between business objectives and technical execution. Skilled in React, Node.js, Agile methodologies, CI/CD, and modern web technologies, with experience in data visualization and dashboard development to drive actionable insights.
            </p>
            ...
            <form onSubmit={handleSubscribe} className="mt-8">
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  type="submit"
                  className="px-8 py-3 rounded-xl bg-blue-600 text-white font-medium hover:bg-blue-500 transition-all duration-300"
                >
                  Subscribe
                </motion.button>
              </div>
          ...
          >
            ...
            <div className="flex space-x-6">
              {socialLinks.map((social) => (
                ...
                >
                  <div className="absolute inset-0 bg-blue-400/10 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                  <div className="relative z-10 text-white group-hover:text-blue-400">
                    {social.icon}
                  </div>
                </motion.a>
              ))}
